...
ques2logit2 <- glm(unemper ~ retail_or_not + retail_or_not*covid_april + YEAR + MONTH + REGION + covid1_dummy + 
                     covid2_dummy + covid3_dummy + AGE + SEX + RACE, data = ques2, 
...
summary(predictions(ques2logit2, variables = list(retail_or_not= 1, covid_april = 1)))
summary(predictions(ques2logit2, variables = list(retail_or_not= 0, covid_april = 0)))
summary(predictions(ques2logit2, variables = list(retail_or_not= 0, covid_april = 1)))
summary(predictions(ques2logit2, variables = list(retail_or_not= 1, covid_april = 0)))
